            ...
            >
              ...
              <div className="relative w-full h-[45%] min-h-[180px] lg:h-full lg:w-[45%] xl:w-[40%] overflow-hidden bg-[var(--color-bg-main)] shrink-0">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-[var(--color-bg-card)] via-[var(--color-bg-card)]/40 to-transparent lg:from-[var(--color-bg-card)] lg:via-[var(--color-bg-card)]/10" />
                </motion.div>
              </div>
