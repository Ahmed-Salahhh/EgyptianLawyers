...
{
    /// <inheritdoc />
    public partial class AddLawyerSuspendAndFcmToken : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyndicateCardNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "LawyerActiveCities",
                columns: table => new
                {
                    ActiveCitiesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActiveLawyersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LawyerActiveCities", x => new { x.ActiveCitiesId, x.ActiveLawyersId });
                    table.ForeignKey(
                        name: "FK_LawyerActiveCities_Cities_ActiveCitiesId",
                        column: x => x.ActiveCitiesId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LawyerActiveCities_Lawyers_ActiveLawyersId",
                        column: x => x.ActiveLawyersId,
                        principalTable: "Lawyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LawyerActiveCities_ActiveLawyersId",
                table: "LawyerActiveCities",
                column: "ActiveLawyersId");
        }
